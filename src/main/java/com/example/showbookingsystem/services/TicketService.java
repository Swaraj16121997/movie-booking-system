...
import com.example.showbookingsystem.models.*;
import com.example.showbookingsystem.repositories.ShowRepository;
import com.example.showbookingsystem.repositories.ShowSeatRepository;
import com.example.showbookingsystem.repositories.TicketRepository;
...
public class TicketService {
    ...
    public Ticket bookMovie(Long userId, Long showId, List<Long> showSeatIds) throws UserNotFoundException, ShowNotFoundException, ShowSeatNotAvailableException {
        ...
        ticket.setTotalAmount(priceCalculatorService.calculateTicketPrice(bookedShowSeats, show));
